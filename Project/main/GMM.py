...
for i, file_path in enumerate(file_paths):
    ...
    gmm = GaussianMixture(n_components=3, covariance_type='diag', random_state=0, reg_covar=1e-5)  # GMM 모델 초기화
...
sns.heatmap(conf, annot=True, fmt='g', cmap='Blues', xticklabels=[f'Test {i+1}' for i in range(10)], yticklabels=[f'Model {i+1}' for i in range(10)])
