...
def load_audio(file_path):
    ...
    mfcc = librosa.feature.mfcc(audio, sr, n_mfcc=108, hop_length=256)  # MFCC 특성 추출
    return mfcc.T


# 오디오 파일 경로 목록
file_paths = [
    "wavfile4/규보_[cut_8sec].wav",
    "wavfile4/아빠_[cut_8sec].wav",
    "wavfile4/엄마_[cut_8sec].wav",
    "wavfile4/유성_[cut_8sec].wav",
    "wavfile4/유찬_[cut_8sec].wav",
    "wavfile4/이모_[cut_8sec].wav",
    "wavfile4/지윤_[cut_8sec].wav",
    "wavfile4/창희_[cut_8sec].wav",
    "wavfile4/할머니_[cut_8sec].wav",
    "wavfile4/형_[cut_8sec].wav",
]
...
# 테스트 음성 파일 경로 목록
test_file_paths = [
    "wavfile4/규보_[cut_3sec].wav",
    "wavfile4/아빠_[cut_3sec].wav",
    "wavfile4/엄마_[cut_3sec].wav",
    "wavfile4/유성_[cut_3sec].wav",
    "wavfile4/유찬_[cut_3sec].wav",
    "wavfile4/이모_[cut_3sec].wav",
    "wavfile4/지윤_[cut_3sec].wav",
    "wavfile4/창희_[cut_3sec].wav",
    "wavfile4/할머니_[cut_3sec].wav",
    "wavfile4/형_[cut_3sec].wav",
]
